...
namespace Senstay.Dojo.Models
{
    ...
    public partial class CPL
    {
        ...
        [Index(IsUnique = false), MaxLength(100)]
        public string Account { get; set; }
        [Index(IsUnique = false), MaxLength(250), DisplayName("Airbnb Home Name")]
        public string AirBnBHomeName { get; set; }
        [Index(IsUnique = false), MaxLength(50)]
        public string PropertyStatus { get; set; }
        public string Address { get; set; }
        [Index(IsUnique = false), MaxLength(50), DisplayName("Product")]
